...
const initialValue_entity_1 = require("../initialValue/initialValue.entity");
let AppConfig = class AppConfig extends primary_model_1.PrimaryModel {
};
__decorate([
    (0, graphql_1.Field)(() => Number, {
        description: "tb_app_config.id",
    }),
    (0, typeorm_1.PrimaryGeneratedColumn)()
], AppConfig.prototype, "id", void 0);
__decorate([
    (0, graphql_1.Field)(() => String, {
        description: "tb_app_config.name",
    }),
    (0, typeorm_1.Column)()
], AppConfig.prototype, "name", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => initialValue_entity_1.InitialValue, (initialValue) => {
        console.log(initialValue);
        return initialValue.appConfigs;
    })
